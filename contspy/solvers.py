...
def solve_Newton(R, J, x0, abs_tol=1.0e-10, rel_tol=1.0e-10, max_iters=200, debug=False):
  """
  ...
  raise Exception('No solution has been found after ', k, ' iterations in the Newton solve.')
